			...
			<div class="main-content">
				...
				<div class="content-nhe">
					...
					<form name="themban" id="themban"
						action="nhahang/ban/suaban.html" method="post"
						enctype="multipart/form-data">
						<input style="display: none" name="idban" type="text"
							value="${ban.id}" id="idban">
						<div class="row rthemtrangmoi">
							...
							<div class="form-group fullname-custom">
								...
								<div class="col-md-10">
									...
									</label> <input type="text" name="soban" id="soban" value="${ban.soban}"
							...
							<div class="form-group fullname-custom">
								...
								<div class="col-md-10">
									<label class="control-label  labeld" for="td">Số người :<span
										style="color: red;">*</span>
									</label> <input type="text" name="songuoi" id="songuoi" value="${ban.songuoi}"
