							...
							<table id="example" class="table table-striped table-bordered">
								...
								<tbody>
									<c:forEach var="bv" items="${baiviet}" varStatus="status">
										...
										<fmt:formatDate var="nt" value="${bv.ngaytao}" pattern="dd-MM-yyyy" />
										<fmt:formatDate var="ns" value="${bv.ngaysua}" pattern="dd-MM-yyyy" />
										<tr>
											<td>
												<input type="checkbox" name="idbaiviet" value="${bv.id}" />
											</td>
