							...
							<div class="content-nhe">
	                			<table id="example" class="table table-striped table-bordered" >
								        ...
								        <c:forEach var="t" items="${trang}" varStatus="status">
								        	...
								        	<fmt:formatDate var="nt" value="${t.ngaytao}" pattern="dd-MM-yyyy"/>
								        	<fmt:formatDate var="ns" value="${t.ngaysua}" pattern="dd-MM-yyyy"/>
								            <tr>
								                <td>${dem}</td>
								                <td>${t.tieude}</td>
								                <td>${t.title}</td>
								                ...
								                <td style="text-align:center">
								                	<a href="trang/edit/${t.id}.html" style="color:green;">Sửa</a>
								                	<a href="trang/delete/${t.id}.html" onclick="return confirm ('Bạn có thực sự muốn xoá trang này')" style="color:red;padding-left:30px;">Xoá</a>
												</td>
								            </tr>
								        </c:forEach>    
								        </tbody>
