			...
			<div class="main-content">
				...
				<div class="content-nhe">
					...
					<form name="themamthuc" id="themamthuc"					
						action="dashboard/amthuc/themamthuc.html" method="post" enctype="multipart/form-data">
							...
							<div class="form-group fullname-custom">
								...
								<div class="col-md-10">
									<label class="control-label  labeld" for="td">Tên loại
										...
										placeholder="VD: Việt Nam" class="form-control">
								</div>
							</div>
						</div>
							...
							<div class="form-group fullname-custom">
								...
								<div class="col-md-10">
									<label class="control-label  labeld" for="name">Name:<span
										...
										placeholder="Example : VietNam " class="form-control">
								</div>
							</div>
						</div>
							...
							<div class="form-group fullname-custom">
								...
								<div class="col-md-10">
									<label class="control-label  labeld" for="mota">Mô tả:<span
										style="color: red;"></span>
									</label> <textarea name="mota" id="mota" placeholder="Ẩm thực của Việt Nam"
									class="form-control"
							...
							<div class="form-group fullname-custom">
								...
								<div class="col-md-10">
									<label class="control-label  labeld" for="description">Description:<span
										style="color: red;"></span>
									</label> <textarea name="description" id="description" placeholder="Culinary of VietNam"
									class="form-control"
									style="min-height: 120px; max-height: 120px; min-width: 100%; max-width: 100%;"></textarea>
								</div>
							</div>
						...
						<div class="row rthemtrangmoi">
							...
							<div class="col-md-3">
								<a href="dashboard/amthuc/index.html" class="btn btn-warning btn-block"
									type="button">Huỷ</a>
							</div>
							<div class="col-md-3"></div>
