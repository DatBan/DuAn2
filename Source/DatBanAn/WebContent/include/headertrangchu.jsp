	...
	<div class="row">
		...
		<div class="row duoi">
			...
			<div class="col-md-3 linkh">
				<a href="javascript:;" class="linkdangnhap" style="text-decoration: none;" data-toggle="modal" data-target="#myModal"><b>Đăng nhập</b></a>
	...
	<div class="container timkiem">
		...
		<div class="row">
			<div class="col-md-4 ">
				<div>					
					<div class="otimk">
						<img style="padding-left: 8px;margin-top: -7px;" src="images/icontim.png"/>
